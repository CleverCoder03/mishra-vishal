  ...
  return (
    <div className="w-full py-4 sm:py-6 md:py-8 font-sans">
      <form className="grid w-full grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        {/* Name Field */}
        <div className="bg-[#f4f4f5] rounded-xl p-5 flex flex-col justify-center min-h-[100px]">
        ...
        {/* Email Field */}
        <div className="bg-[#f4f4f5] rounded-xl p-5 flex flex-col justify-center min-h-[100px]">
          <label htmlFor="email" className="text-sm font-medium text-gray-900 mb-1">e-mail</label>
          <input
            type="email"
            id="email"
        ...
        <div className="md:col-span-2 pt-2 flex justify-start">
          <button
            type="submit"
            className="bg-[#1a1a1a] hover:bg-black text-white text-lg font-medium py-4 px-10 rounded-xl transition-colors duration-200"
          >
            Submit
          </button>
        </div>
